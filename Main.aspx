...
<html >
    ...
    <head>
        ...
        <!-- App css -->
        <link href="assets/css/app-modern-rtl.css" rel="stylesheet" />
            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-title side-nav-item">القائمة </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarDashboards">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="dashboard-analytics.html">جدول الموظفين </a>
                                    </li>
                                    <li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarDashboards">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="dashboard-analytics.html">طلبات الإجازات  </a>
                                    </li>
                                    <li>
                                        <a href="index.html">طلبات الدوام  </a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarCrm">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="crm-projects.html">استعلام الإجازات </a>
                                    </li>
                                    <li>
                                        <a href="crm-orders-list.html"> أرصدة الإجازات </a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-ecommerce-products.html">الدوام حسب الساعة </a>
                                    </li>
                                    <li>
                                        <a href="apps-ecommerce-products-details.html">الدوام حسب الساعات المطلوبة </a>
                                    </li>
                                    <li>
                                        <a href="apps-ecommerce-orders.html">الدوام حسب نظام الوردية </a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEmail">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-email-inbox.html">كشف الرواتب </a>
                                    </li>
                                    <li>
                                        <a href="apps-email-read.html">المهام </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                    ...
                                    <div class="page-title-box">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div class="row mt-3 " >
                                                    <div class="col-1">الفعالية</div>

                                                    <div class="col">
                                                        <asp:DropDownList ID="Active" runat="server" CssClass="form-control " AutoPostBack="True">
                                                            <asp:ListItem>الكل</asp:ListItem>
                                                            <asp:ListItem>فعال</asp:ListItem>
                                                            <asp:ListItem>غير فعال</asp:ListItem>
                                                            <asp:ListItem>مجاز</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <asp:GridView ID="DG" runat="server" DataSourceID="sqlemps"
                                                    CssClass=" mt-3  table table-striped" AutoGenerateColumns="False">

                                                    <Columns>
                                                        <asp:BoundField DataField="EmployeeID" HeaderText="رقم الموظف" />
                                                        <asp:BoundField DataField="EmployeeName" HeaderText="اسم الموظف" />
                                                        <asp:BoundField DataField="RefMobile" HeaderText="رقم الهاتف" />
                                                        <asp:BoundField DataField="JobName" HeaderText="المسمى الوظيفي " />
                                                        <asp:BoundField DataField="Department" HeaderText=" القسم  " />
                                                        <asp:BoundField DataField="Branch" HeaderText="الفرع" />
                                                        <asp:BoundField DataField="PeriodFromStart" HeaderText="الفترة الزمنية" />
                                                        <asp:BoundField DataField="EmplStatus" HeaderText="  الفعالية  " />
                                        ...
                                        <asp:SqlDataSource runat="server" ID="sqlemps" ConnectionString="<%$ ConnectionStrings:OrdersAppConnectionString %>"
                                            SelectCommand="SELECT [EmployeeID] ,[EmployeeName]  ,[RefMobile]  ,[JobName] ,[Department] ,[Branch],[PeriodFromStart] ,[Active] ,[EmplStatus] FROM [dbo].[EmployeesView] where EmplStatus=N'فعال' "></asp:SqlDataSource>
