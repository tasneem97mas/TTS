<%@ Page Language="VB" AutoEventWireup="false" CodeFile="vacations.aspx.vb" Inherits="vacations" %>
            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-title side-nav-item">نظام الموظفين </li>
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarDashboards" aria-expanded="false"
                                ...
                                <span class="badge  float-end">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:Label ID="lblcnt" runat="server" BackColor="Gray" style="padding-left:10px; padding-right:10px ;border-radius:3px 3px 3px 3px; " Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>   
                            ...
                            <div class="collapse" id="sidebarDashboards">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="main_.aspx">جدول الموظفين</a>
                                    </li>
                                    <li>
                                        <a href="index.html">بطاقات الموظفين</a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarCrm">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="crm-projects.html">طلبات الإجازات</a>
                                    </li>
                                    <li>
                                        <a href="crm-orders-list.html">طلبات الدوام</a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-ecommerce-products.html">استعلام الإجازات</a>
                                    </li>
                                    <li>
                                        <a href="apps-ecommerce-products-details.html">أرصدة الإجازات</a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEmail">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-email-inbox.html">الدوام حسب الساعة</a>
                                    </li>
                                    <li>
                                        <a href="apps-email-read.html"> الدوام حسب الساعات المطلوبة</a>
                                    </li>
                                     <li>
                                        <a href="apps-email-read.html"> الدوام حسب نظام الوردية</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarProjects">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-projects-list.html">كشف الرواتب</a>
                                    </li>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div class="row mt-3 align-items-end " >
                                                    ...
                                                    <div class="col-sm-3">
                                                          <asp:DropDownList ID="vac" runat="server" CssClass="form-select" AutoPostBack="True">
                                                            <asp:ListItem  Selected="True">الكل</asp:ListItem>
                                                            <asp:ListItem>أمومة</asp:ListItem>
                                                            <asp:ListItem>بدون راتب</asp:ListItem>
                                                            <asp:ListItem>سنوية</asp:ListItem>
                                                            <asp:ListItem>عطل رسمية</asp:ListItem>
                                                            <asp:ListItem>عطلة اسبوعية</asp:ListItem>
                                                            <asp:ListItem>مرضية</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="nam" CssClass="form-control" runat="server" placeholder="نص البحث"></asp:TextBox>
                                                            <div class="input-group-append">
                                                                 
                                                                 <asp:Button ID="btnSearch" CssClass="btn btn-primary" runat="server" Text="بحث" />
                                                            </div>
                                                        </div>
                                                ...
                                                <asp:GridView ID="DG" runat="server" DataSourceID="sqlemps" BorderWidth="0"
                                                    CssClass=" mt-3 table table-striped table-responsive  nowrap w-100" AllowSorting="true"  AutoGenerateColumns="False">

                                                    <Columns>
                                                        <asp:BoundField DataField="VocID" HeaderText="رقم الإجازة"  SortExpression="EmployeeID"/>
                                                        <asp:BoundField DataField="EmployeeName" ItemStyle-Wrap="false"  HeaderText="اسم الموظف" SortExpression="EmployeeName" />
                                                       
                                                       
                                                        <asp:BoundField DataField="JobName" HeaderText="المسمى الوظيفي" SortExpression="JobName" />
                                                        <asp:BoundField DataField="Department" HeaderText="القسم"  SortExpression="Department" />
                                                        <asp:BoundField DataField="Branch" HeaderText="الفرع"  SortExpression="Branch" />
                                                         <asp:BoundField DataField="Vocation" HeaderText="نوع الإجازة"  />
                                                        <asp:BoundField DataField="FromDate" HeaderText="من تاريخ"  DataFormatString="{0:yyyy-MM-dd}"  ItemStyle-Wrap="false"/>
                                                        <asp:BoundField DataField="ToDate" HeaderText="الى تاريخ"  DataFormatString="{0:yyyy-MM-dd}"  ItemStyle-Wrap="false"/>
                                                        <asp:BoundField DataField="NoDays" HeaderText="الأيام"  />
                                        ...
                                        <asp:SqlDataSource runat="server" ID="sqlemps" ConnectionString="<%$ ConnectionStrings:OrdersAppConnectionString %>"
                                            SelectCommand="SELECT  [VocID],[EmployeeName],[JobName],[Department] ,[Branch],[Vocation],[FromDate],[ToDate] ,[NoDays] FROM [OrdersApp].[dbo].[VocationView]   order by  EmployeeName asc"></asp:SqlDataSource>
