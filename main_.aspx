<%@ Page Language="VB" AutoEventWireup="false" CodeFile="main_.aspx.vb" Inherits="main_" %>
                    ...
                    <ul class="side-nav">
                            ...
                            <a data-bs-toggle="collapse" href="#sidebarDashboards" aria-expanded="false"
                                ...
                                <span class="badge  float-end">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:Label ID="lblcnt" runat="server" style="padding-left:10px; padding-right:10px ;border-radius:3px 3px 3px 3px; " Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>   
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="vacations.aspx">استعلام الإجازات</a>
                                    </li>
                                    <li>
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div class="row mt-3 align-items-end " >
                                                    ...
                                                    <div class="col-sm-3">
                                                          <asp:DropDownList ID="Active" runat="server" CssClass="form-select" AutoPostBack="True">
                                                            <asp:ListItem >الكل</asp:ListItem>
                                                            <asp:ListItem Selected="True">فعال</asp:ListItem>
                                                ...
                                                <asp:GridView ID="DG" runat="server" DataSourceID="sqlemps" BorderWidth="0"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="EmployeeID" HeaderText="رقم الموظف"  SortExpression="EmployeeID"/>
                                                        ...
                                                        <asp:BoundField DataField="PeriodFromStart" ItemStyle-Wrap="false" HeaderText="الفترة الزمنية" />
                                                         
                                                         
                                                        <asp:TemplateField HeaderText="الفعالية"  >
                                                            <ItemTemplate>
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <asp:Label ID="Label3" Width="80"  runat="server" Text="فعال" cssclass="btn bg-success text-white btn-block "    style="padding:2px; border-radius: 2px 7px 2px 7px"   Visible='<%#If(Eval("EmplStatus") = "فعال", "TRUE", "FALSE")%>'>  </asp:Label>
                                                                        <asp:Label ID="Label4" Width="80"  runat="server" Text="غير فعال" cssclass="btn btn-danger btn-block "  style="padding:2px;border-radius: 2px 7px 2px 7px"  Visible='<%#If(Eval("EmplStatus") = "غير فعال", "TRUE", "FALSE")%>'></asp:Label>
                                                                        <asp:Label ID="Label5" Width="80" runat="server" Text="مجاز"  CssClass="btn btn-warning btn-block  " style="padding:2px; border-radius: 2px 7px 2px 7px"    Visible='<%#If(Eval("EmplStatus") = "مجاز", "TRUE", "FALSE")%>'></asp:Label>
                                        ...
                                        <asp:SqlDataSource runat="server" ID="sqlemps" ConnectionString="<%$ ConnectionStrings:OrdersAppConnectionString %>"
                                            SelectCommand="SELECT [EmployeeID] ,[EmployeeName]  ,[RefMobile]  ,[JobName] ,[Department] ,[Branch],[PeriodFromStart] ,[Active] ,[EmplStatus] FROM [dbo].[EmployeesView] where EmplStatus=N'فعال' order by  EmployeeName asc"></asp:SqlDataSource>
